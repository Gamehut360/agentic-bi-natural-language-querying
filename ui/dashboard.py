...
# --- PAGE CONFIG ---
st.set_page_config(
    page_title="Agentic BI | Insights Engine",
    page_icon="🤖",
    layout="wide",
...
# --- SIDEBAR ---
with st.sidebar:
    st.markdown("<h1 style='color: #7267EF;'>🤖 Agentic BI</h1>", unsafe_allow_html=True)
...
st.divider()
st.caption(f"Last sync: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} | Agentic BI SaaS v1.0")
